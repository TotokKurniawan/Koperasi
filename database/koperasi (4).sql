...
--
-- Host: localhost:3306
-- Generation Time: Dec 25, 2022 at 05:49 AM
...
('AGT007', 'Andin Kiw kiw', 'Jalan doang ngga jadian', '2002-12-01', 'Jember', 'Perempuan', '1', '081231948234', 75000, 'uploads/y.png');
...
(8, 'andin', 'Perempuan', 'kepode', 'jalanin aja dulu', '', 1);
...
INSERT INTO `k_pinjaman` (`id_k_pinjaman`, `nama_pinjaman`, `keterangan_pinjaman`) VALUES
...
(96, 'Simpanan Pokok', 'AGT007', '2022-12-09', 50000, 'Simpanan Pokok yang dibayarkan pertama kali oleh anggota koperasi dan hanya sekali saja', '12'),
(97, 'Simpanan Wajib', 'AGT007', '2022-12-09', 25000, 'Simpanan Wajib yang dibayarkan oleh anggota setiap bulannya', '12');
...
--
ALTER TABLE `simpanan`
  MODIFY `id_simpanan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
